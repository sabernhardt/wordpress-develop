...
function twentyseventeen_setup() {
	 ...
	 */
	$font_stylesheet = str_replace( array( get_template_directory_uri() . '/', get_stylesheet_directory_uri() . '/' ), '', twentyseventeen_fonts_url() );
...
function twentyseventeen_scripts() {
	...
	$font_version = ( 0 === strpos( (string) twentyseventeen_fonts_url(), get_template_directory_uri() . '/' ) ) ? '20221101' : null;
